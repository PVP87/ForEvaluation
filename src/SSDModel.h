...
class SSDModel
{
  ...
  private:
    ...
    const std::string class_file = "C:/ExampleCode/OpenCV_SSD_MobileNet/model/object_detection_classes_coco.txt";
    const std::string model_file = "C:/ExampleCode/OpenCV_SSD_MobileNet/model/frozen_inference_graph.pb";
    const std::string config_file = "C:/ExampleCode/OpenCV_SSD_MobileNet/model/ssd_mobilenet_v2_coco_2018_03_29.pbtxt";
